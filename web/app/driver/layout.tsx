...
import { Package, LayoutDashboard, ClipboardCheck, MapPin, LogOut } from 'lucide-react'
import { useAuth } from '../../lib/auth-context'
import { Spinner } from '../../components/ui'

const links = [
  { href: '/driver', label: 'Dashboard', icon: LayoutDashboard, exact: true },
  { href: '/driver/available', label: 'Available Orders', icon: ClipboardCheck },
  { href: '/driver/deliveries', label: 'My Deliveries', icon: MapPin },
]
        ...
        <div className="px-4 py-5 border-b border-zinc-800">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-sky-400 leading-none mt-0.5 uppercase tracking-wider">Driver</p>
            </div>
          </Link>
        </div>
